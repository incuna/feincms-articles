...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('articles_category_access_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('category', models.ForeignKey(orm['articles.category'], null=False)),
            ('group', models.ForeignKey(orm['auth.group'], null=False))
        ))
        db.create_unique('articles_category_access_groups', ['category_id', 'group_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field access_groups on 'Category'
        db.delete_table('articles_category_access_groups')
