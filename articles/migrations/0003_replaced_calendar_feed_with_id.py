...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Category.calendar_feed'
        db.delete_column('articles_category', 'calendar_feed')

        # Adding field 'Category.calendar_id'
        db.add_column('articles_category', 'calendar_id', self.gf('django.db.models.fields.EmailField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Category.calendar_feed'
        db.add_column('articles_category', 'calendar_feed', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Deleting field 'Category.calendar_id'
        db.delete_column('articles_category', 'calendar_id')
