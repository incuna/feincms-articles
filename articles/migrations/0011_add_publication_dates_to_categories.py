...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Category.publication_date'
        db.add_column('articles_category', 'publication_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Category.publication_end_date'
        db.add_column('articles_category', 'publication_end_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Category.publication_date'
        db.delete_column('articles_category', 'publication_date')

        # Deleting field 'Category.publication_end_date'
        db.delete_column('articles_category', 'publication_end_date')
